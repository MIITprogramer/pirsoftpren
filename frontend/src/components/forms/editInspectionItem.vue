...
const props = defineProps(["editItem", "editData"]);

const methods = ref([]);
const types = ref([]);
const myType = ref(props.editData.type);
const formData = reactive({
  itemName: props.editData.itemName,
  method: props.editData.method,
  type: props.editData.type,
  standart: props.editData.standart,
});

const rangeData = reactive({
  value: props.editData.standart.value,
  tolerance: props.editData.standart.tolerance,
  unit: props.editData.standart.unit,
});

const rangeData2 = reactive({
  value: props.editData.standart.value,
  upperTolerance: props.editData.standart.upperTolerance,
  lowerTolerance: props.editData.standart.lowerTolerance,
  unit: props.editData.standart.unit,
});
